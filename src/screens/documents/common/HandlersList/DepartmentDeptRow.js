...
import HandlersDeptList from './HandlersDeptList';

const DepartmentDeptRow = ({ name, children, headerSelect, onSelect, selected }) => {
  ...
  return (
    <View>
      ...
      {showSub && <HandlersDeptList handlers={children} selected={selected} onSelect={onSelect} />}
    </View>
  );
};

DepartmentDeptRow.propTypes = {
...
DepartmentDeptRow.defaultProps = {
  headerSelect: false,
  onSelect() {},
  selected: {},
};

export default DepartmentDeptRow;
