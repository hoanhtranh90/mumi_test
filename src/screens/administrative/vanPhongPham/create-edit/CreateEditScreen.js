...
import { createRequest } from '../../../../store/administrative/vanPhongPham/reducer';
...
const mapStateToProps = state => ({
  vanPhongPhamDetail: state.vanPhongPham.vanPhongPhamDetail,
  editMode: state.vanPhongPham.editMode,
