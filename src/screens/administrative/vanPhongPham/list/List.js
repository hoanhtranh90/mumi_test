...
import {
  ...
  changeMode,
  openCreateRequest,
  getVanPhongPhamDetail,
} from '../../../../store/administrative/vanPhongPham/reducer';
...
const mapDispatchToProps = {
  ...
  getVanPhongPhamDetail: getVanPhongPhamDetail,
};

const mapStateToProps = ({ vanPhongPham }) => ({
  listProcessedRequest: vanPhongPham.listProcessedRequest,
  listProcessingRequest: vanPhongPham.listProcessingRequest,
  mode: vanPhongPham.mode,
});
