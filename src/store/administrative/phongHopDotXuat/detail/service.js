...
export const getRoomFree = query =>
  axios.get('/phonghop/roomfree', { params: formatQuery(query) }).then(res => res.data);

export const calendarRoom = query =>
  axios.get('/phonghop/calendarRoom', { params: formatQuery(query) }).then(res => res.data.data);
